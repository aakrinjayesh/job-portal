...
// function EducationCard({ title = "Education", apidata, onEductionChange }) {
//   const [isModalOpen, setIsModalOpen] = useState(false);
//   const [form] = Form.useForm();
//   const [editingIndex, setEditingIndex] = useState(null);

//   // Example data (you can replace it with props or state from parent)

//   const [educationList, setEducationList] = useState(apidata);
...
//       if (onEductionChange) {
//         onEductionChange(educationList);
//       }
//     });
//   };
