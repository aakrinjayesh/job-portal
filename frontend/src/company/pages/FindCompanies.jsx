...
//   // const typeKey = company.partnerType?.replace(" Partner", "");
...
//           {/* Partner Tier Badge */}
//           <div style={{ ...styles.partnerBadge, ...styles.partnerBadgeTier }}>
//             {tierLogo && (
...
//               </div>
//             )}
//             <div style={styles.partnerBadgeInner}>
//               <span style={{ ...styles.partnerBadgeLabel, color: "#534AB7" }}>
//                 Partner Tier
//               </span>
//               <span style={{ ...styles.partnerBadgeValue, color: "#3C3489" }}>
//                 {company.partnerTier || "—"}
//               </span>
//             </div>
//           </div>
...
//           {/* Partner Type Badge */}
//           <div style={{ ...styles.partnerBadge, ...styles.partnerBadgeType }}>
//             {typeLogo && (
//               <div style={styles.partnerLogoWrap}>
//                 <img
//                   src={typeLogo}
...
//             )}
//             <div style={styles.partnerBadgeInner}>
//               <span style={{ ...styles.partnerBadgeLabel, color: "#3B6D11" }}>
//                 Partner Type
//               </span>
//               <span style={{ ...styles.partnerBadgeValue, color: "#27500A" }}>
//                 {/* {company.partnerType || "—"} */}
