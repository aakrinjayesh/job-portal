...
import {
  getAdminCreateUserWelcomeEmailTemplate,
...
const adminCreateUser = async (req, res) => {
  try {
    ...
    // Send welcome email (no OTP, just a notification)
    await sendEmail({
      to: email,
      subject: "Welcome! Your account has been created",
      text: `Hi ${name}, your account has been created by an admin.`,
      html: getAdminCreateUserWelcomeEmailTemplate({ name, email, role }),
    });
