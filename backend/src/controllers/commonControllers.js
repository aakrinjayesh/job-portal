...
const updateSkills = async (req, res) => {
  ...
  if (!name) {
    ...
    return res
      .status(400)
      .json({ status: "error", message: "Skill name is required" });
  }
  try {
...
const updateCertifications = async (req, res) => {
  ...
  if (!name) {
    ...
    return res
      .status(400)
      .json({ status: "error", message: "Certification name is required" });
  }
  try {
    ...
    if (check) {
      ...
      return res
        .status(409)
        .json({ status: "error", message: "Certification already exists" });
    }
...
const updateLocation = async (req, res) => {
  ...
  if (!name) {
    ...
    return res
      .status(400)
      .json({ status: "error", message: "Location name is required" });
  }
  try {
    ...
    if (check) {
      ...
      return res
        .status(409)
        .json({ status: "error", message: "Location already exists" });
    }
...
const addCloud = async (req, res) => {
  ...
  if (!name) {
    ...
    return res
      .status(400)
      .json({ status: "error", message: "Cloud name is required" });
  }
  try {
    ...
    if (check) {
      ...
      return res
        .status(409)
        .json({ status: "error", message: "Cloud already exists" });
    }
...
const addQualification = async (req, res) => {
  ...
  if (!name) {
    ...
    return res
      .status(400)
      .json({ status: "error", message: "qualification name is required" });
  }
  try {
    ...
    if (check) {
      ...
      return res
        .status(409)
        .json({ status: "error", message: "qualification already exists" });
    }
